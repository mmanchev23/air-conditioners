# Generated by Django 4.0.4 on 2022-05-01 07:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_likes', to='app.customer')),
                ('technician', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.tech')),
            ],
        ),
        migrations.CreateModel(
            name='Administrator',
